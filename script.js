...
function touchMoveHandler(event) {
    ...
    /*reset board and reset high score buttons*/
    document.getElementById('reset-board').addEventListener('click', restartGame);
    function highRestart() {
        highScore = 0;
        highScoreElem.textContent = '0';
        gameOverElem.style.display = 'none';
        initializeGame();
    }
    document.getElementById('reset-high-score').addEventListener('click', highRestart);
